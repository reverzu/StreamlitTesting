        ...
        if res.face_landmarks:
            ...
            if res.left_hand_landmarks:
                for i in res.left_hand_landmarks.landmark:
                    frames_list.append(i.x - res.left_hand_landmarks.landmark[8].x)
                    frames_list.append(i.y - res.left_hand_landmarks.landmark[8].y)
            else:
                for i in range(42):
            ...
            if res.right_hand_landmarks:
                for i in res.right_hand_landmarks.landmark:
                    frames_list.append(i.x - res.right_hand_landmarks.landmark[8].x)
                    frames_list.append(i.y - res.right_hand_landmarks.landmark[8].y)
            else:
                for i in range(42):
                    frames_list.append(0.0)
